...
EXAMPLE_WEIGHTS_MAP = {
    # FedRL — ranked.pkl was copied from v3_pos-reward-aggr_ranked.pkl (canonical per D-02)
    ("FedRL", "grid-3x3"):       "example_weights/ICCPS/Final/FedRL/grid-3x3/ranked.pkl",
    ("FedRL", "grid-5x5"):       "example_weights/ICCPS/Final/FedRL/grid-5x5/ranked.pkl",
    ("FedRL", "cologne-8"):      "example_weights/ICCPS/Final/FedRL/cologne-8/ranked.pkl",
    # MARL — ranked.pkl was copied from v3_ranked.pkl
    ("MARL", "grid-3x3"):        "example_weights/ICCPS/Final/MARL/grid-3x3/ranked.pkl",
    ("MARL", "grid-5x5"):        "example_weights/ICCPS/Final/MARL/grid-5x5/ranked.pkl",
    ("MARL", "cologne-8"):       "example_weights/ICCPS/Final/MARL/cologne-8/ranked.pkl",
    # SARL — ranked.pkl was copied from v3_ranked.pkl
    ("SARL", "grid-3x3"):        "example_weights/ICCPS/Final/SARL/grid-3x3/ranked.pkl",
    ("SARL", "grid-5x5"):        "example_weights/ICCPS/Final/SARL/grid-5x5/ranked.pkl",
    ("SARL", "cologne-8"):       "example_weights/ICCPS/Final/SARL/cologne-8/ranked.pkl",
    # Trained on HPC via scripts/train_missing_trainers.py
    ("MeanField", "grid-3x3"):   "example_weights/ICCPS/Final/MeanField/grid-3x3/ranked.pkl",
    ("MeanField", "grid-5x5"):   "example_weights/ICCPS/Final/MeanField/grid-5x5/ranked.pkl",
    ("MeanField", "cologne-8"):  "example_weights/ICCPS/Final/MeanField/cologne-8/ranked.pkl",
    ("CTDE", "grid-3x3"):        "example_weights/ICCPS/Final/CTDE/grid-3x3/ranked.pkl",
    ("CTDE", "grid-5x5"):        "example_weights/ICCPS/Final/CTDE/grid-5x5/ranked.pkl",
    ("CTDE", "cologne-8"):       "example_weights/ICCPS/Final/CTDE/cologne-8/ranked.pkl",
    ("Gossip", "grid-3x3"):      "example_weights/ICCPS/Final/Gossip/grid-3x3/ranked.pkl",
    ("Gossip", "grid-5x5"):      "example_weights/ICCPS/Final/Gossip/grid-5x5/ranked.pkl",
    ("Gossip", "cologne-8"):     "example_weights/ICCPS/Final/Gossip/cologne-8/ranked.pkl",
    ("HierFed", "grid-3x3"):     "example_weights/ICCPS/Final/HierFed/grid-3x3/ranked.pkl",
    ("HierFed", "grid-5x5"):     "example_weights/ICCPS/Final/HierFed/grid-5x5/ranked.pkl",
    ("HierFed", "cologne-8"):    "example_weights/ICCPS/Final/HierFed/cologne-8/ranked.pkl",
    ("FedDistill", "grid-3x3"):  "example_weights/ICCPS/Final/FedDistill/grid-3x3/ranked.pkl",
    ("FedDistill", "grid-5x5"):  "example_weights/ICCPS/Final/FedDistill/grid-5x5/ranked.pkl",
    ("FedDistill", "cologne-8"): "example_weights/ICCPS/Final/FedDistill/cologne-8/ranked.pkl",
    # grid-7x7 — trained on HPC
    ("FedRL", "grid-7x7"):       "example_weights/ICCPS/Final/FedRL/grid-7x7/ranked.pkl",
    ("MARL", "grid-7x7"):        "example_weights/ICCPS/Final/MARL/grid-7x7/ranked.pkl",
    ("SARL", "grid-7x7"):        "example_weights/ICCPS/Final/SARL/grid-7x7/ranked.pkl",
    ("MeanField", "grid-7x7"):   "example_weights/ICCPS/Final/MeanField/grid-7x7/ranked.pkl",
    ("CTDE", "grid-7x7"):        "example_weights/ICCPS/Final/CTDE/grid-7x7/ranked.pkl",
    ("Gossip", "grid-7x7"):      "example_weights/ICCPS/Final/Gossip/grid-7x7/ranked.pkl",
    ("HierFed", "grid-7x7"):     "example_weights/ICCPS/Final/HierFed/grid-7x7/ranked.pkl",
    ("FedDistill", "grid-7x7"):  "example_weights/ICCPS/Final/FedDistill/grid-7x7/ranked.pkl",
}
