...
def main(options):
    # Resolve duarouter binary here (not at module level) so importing this
    # module in Ray worker processes doesn't trigger a binary lookup that can
    # fail or block when SUMO is not yet initialised in the worker environment.
