...
def generate_random_routes(
    ...
    """
    # Deferred import: random_trips triggers sumolib.checkBinary("duarouter") at
    # module level, which fails in Ray worker processes during initialisation.
    # Importing here (inside the function) means workers can import random_routes
    # cleanly; the import only fires when routes are actually being generated.
    from seal.sumo.utils import random_trips  # noqa: PLC0415
